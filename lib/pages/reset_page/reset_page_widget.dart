...
class ResetPageWidget extends StatefulWidget {
  const ResetPageWidget({Key? key}) : super(key: key);
...
class _ResetPageWidgetState extends State<ResetPageWidget> {
  ...
  void initState() {
    ...
    _model.emailresetFieldController ??= TextEditingController();
  }
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Please enter the email that you need to reset ',
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    controller: _model.emailresetFieldController,
                    autofocus: true,
                    obscureText: false,
                    ...
                    style: FlutterFlowTheme.of(context).bodyMedium,
                    validator: _model.emailresetFieldControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    if (_model.emailresetFieldController.text.isEmpty) {
                    ...
                    await resetPassword(
                      email: _model.emailresetFieldController.text,
                      context: context,
                    );
                  },
                  text: 'Reset Password',
