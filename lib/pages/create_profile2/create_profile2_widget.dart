...
class CreateProfile2Widget extends StatefulWidget {
  const CreateProfile2Widget({Key? key}) : super(key: key);

  @override
  _CreateProfile2WidgetState createState() => _CreateProfile2WidgetState();
}
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'Fill your basic details to complete signup',
