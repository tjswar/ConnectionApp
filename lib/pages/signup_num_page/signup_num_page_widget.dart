...
import 'signup_num_page_model.dart';
export 'signup_num_page_model.dart';

class SignupNumPageWidget extends StatefulWidget {
  const SignupNumPageWidget({Key? key}) : super(key: key);

  @override
  _SignupNumPageWidgetState createState() => _SignupNumPageWidgetState();
}

class _SignupNumPageWidgetState extends State<SignupNumPageWidget> {
  late SignupNumPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignupNumPageModel());
